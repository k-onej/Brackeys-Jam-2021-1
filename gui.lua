...
function GUI:update(dt) --exists
  
end

function GUI:draw() --draws all of the gui items
  self:displayHearts()
  self:displayCoins()
  self:displayCoinText()
end

function GUI:displayHearts() --draws hearts
...
function GUI:displayCoins() --draws coin indicator
  love.graphics.setColor(0,0,0,0.5)
...
function GUI:displayCoinText() --draws text representing amount of coins
